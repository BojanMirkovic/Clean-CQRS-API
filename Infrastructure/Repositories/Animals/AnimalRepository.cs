...
namespace Infrastructure.Repositories.Animals
{
    public class AnimalRepository : IAnimalRepository
    {
        ...
        //public async Task<List<Animal>> GetAllAnimalsByUserId(Guid id)
        //{


        //    try
        //    {
        //        //return await _sqlDatabase.Animals
        //        // .Join(_sqlDatabase.UsersHaveAnimals,
        //        //       animal => animal.AnimalId,
        //        //       animalUser => animalUser.AnimalId,
        //        //       (animal, animalUser) => new { Animal = animal, AnimalUser = animalUser })
        //        // .Where(join => join.AnimalUser.UserId == id)
        //        // .Select(join => join.Animal)
        //        // .ToListAsync();

        //        //var query = from a in TableA
        //        //            join b in TableB
        //        //            on a.CommonColumn equals b.CommonColumn
        //        //            select new { ColumnFromA = a.Column1, ColumnFromB = b.Column2 };
        //        // Assuming you have collections/lists for UsersHaveAnimals and Animal
        //        // Replace these with your actual collections or database context

        //        // Sample data for UsersHaveAnimals table
        //        var usersHaveAnimals = await _sqlDatabase.UsersHaveAnimals.ToListAsync();
        ...
        //        var userId = id; // Replace this with the specific userId you want to query
        ...
        //        // Retrieve the result
        //        return queryResult; // Get the first matching result or null if no match
        ...
        //        //try
        //        //{
        //        //    var usersHaveAnimals = await GetUsersHaveAnimalsByUserId(id);

        //        //    // Extract AnimalIds associated with the provided UserId
        //        //    var animalIds = usersHaveAnimals.Select(uha => uha.AnimalId).ToList();

        //        //    // Retrieve animals filtered by the extracted AnimalIds
        //        //    var animals = await _sqlDatabase.Animals
        //        //        .Where(animal => animalIds.Contains(animal.AnimalId))
        //        //        .ToListAsync();
